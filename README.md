...
# 🩵 주요 기능
<h3> 1. AI 문제 생성</h3>
   OpenAI API를 활용하여 NPC가 실시간으로 학습 문제를 출제합니다. 단순히 저장된 문제를 불러오는 방식이 아니라,
...
또한 본 시스템은 학교와 학원에서 개별 학생 맞춤형 학습 도구로 활용할 수 있으며, 공교육과 사교육에서 학생 수준에 맞는 학습 자료 제공과 학습 성취도 관리에 도움을 
줄 수 있습니다. 더 나아가, 교육 관련 연구 기관이나 학습 데이터 분석 분야에서도 학습 패턴과 난이도 조정을 위한 데이터 수집 및 분석 도구로 활용될 수 있습니다.
<br>
