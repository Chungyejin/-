...
**Run & Learn**은 이러한 문제를 해결하고자 **AI 기반 학습**과 **게임적 몰입 요소**를 결합하여 개발되었습니다. 학생들은 RPG 환경 속에서 AI가 실시간으로 생성한 문제를 풀며 **자기주도적 학습**을 경험할 수 있습니다. 이를 통해 **학습 동기와 집중력을 높이고, 학습 과정 자체에 흥미를 느낄 수 있도록** 돕습니다.  
